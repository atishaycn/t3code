...
export const PROVIDER_CACHE_IDS = ["codex", "pi", "claudeAgent"] as const satisfies ReadonlyArray<
...
export const hydrateCachedProvider = (input: {
  ...
  const hydratedProvider: ServerProvider = {
    ...
    ...(input.cachedProvider.extensions ? { extensions: input.cachedProvider.extensions } : {}),
  };
