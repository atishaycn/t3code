...
import Migration0025 from "./Migrations/025_ProjectionThreadsPinned.ts";
import Migration0026 from "./Migrations/026_RepairLegacyOrchestrationEventsSchema.ts";
...
export const migrationEntries = [
  ...
  [25, "ProjectionThreadsPinned", Migration0025],
  [26, "RepairLegacyOrchestrationEventsSchema", Migration0026],
] as const;
